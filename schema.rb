...
ActiveRecord::Schema.define(version: 2019_02_17_153830) do

  create_table "decision_futurs", force: :cascade do |t|
    t.integer "decision_id"
    t.integer "futur_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["decision_id"], name: "index_decision_futurs_on_decision_id"
    t.index ["futur_id"], name: "index_decision_futurs_on_futur_id"
  end
